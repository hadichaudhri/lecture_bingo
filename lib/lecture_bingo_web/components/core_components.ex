defmodule LectureBingoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LectureBingoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LectureBingoWeb.Gettext, "errors", msg, opts)
    end
  end
